...
Same thing can also be done with double quotes
'''
...
list = ["alef", "bet", "gimel"]  # Sequence Type
print(list, type(list))
tuple = ("alef", "bet", "gimel")  # Sequence Type
print(tuple, type(tuple))
set = {"alef", "bet", "gimel"}  # Set Type
print(set, type(set))
frozen_set = frozenset({"apple", "banana", "cherry"})  # Set Type
print(frozen_set, type(frozen_set))
dictionary = {"name": "Antor", "age": 20}  # Mapping Type
...
# memory_view = memoryview(bytes(6)) # Binary Type
